export default [
  ...
  {
    img: 'https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDV8fG1vdW50YWluc3xlbnwwfHx8fDE2NjgxNjMyMjA&ixlib=rb-1.2.1&q=80&w=1080',
    title: 'Nature View 3',
    subtitle:
      '<p>Experience the beauty of <strong>nature</strong> like never before',
    buttonLabel: 'Explore now',
